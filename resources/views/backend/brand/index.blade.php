...
@section('main-content')
 ...
 <div class="card shadow mb-4 m-3">
    ...
    <div class="card-header py-3 rounded-top">
      <h6 class="mt-1font-weight-bold float-left">Brand List</h6>
      <a href="{{route('brand.create')}}" class="btn btn-sm float-right brandBtn" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Brand</a>
    </div>
