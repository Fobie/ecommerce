...
@section('main-content')
 ...
 <div class="card shadow mb-4 m-3">
    ...
    <div class="card-header py-3 rounded-top">
      <h6 class="mt-2 font-weight-bold float-left">Users List</h6>
      <a href="{{route('users.create')}}" class="btn btn-sm float-right userBtn" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add User</a>
    </div>
    <div class="card-body">
