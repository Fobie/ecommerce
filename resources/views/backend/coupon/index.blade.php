...
@section('main-content')
 ...
 <div class="card shadow mb-4 m-3">
    ...
    <div class="card-header py-3 rounded-top">
      <h6 class="mt-2 font-weight-bold float-left">Coupon List</h6>
      <a href="{{route('coupon.create')}}" class="btn btn-sm float-right couponBtn" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Coupon</a>
    </div>
