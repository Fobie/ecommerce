...
@section('main-content')
 ...
 <div class="card shadow mb-4 m-3">
    ...
    <div class="card-header py-3 rounded-top">
      <h6 class="mt-2 font-weight-bold float-left">Post Tag Lists</h6>
      <a href="{{route('post-tag.create')}}" class="btn btn-sm float-right postTagBtn" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Post Tag</a>
    </div>
